...
var jetpackFuel : float;
var jetpackFuelMax : float;
...
function ApplyJumping ()
{
	...
	else if (Input.GetButton("Jump") && jetpackFuel > 0) 
	{
		//use jetpack
		if (verticalSpeed < 2.5)
		{
			verticalSpeed += .85;
...
function Update() {
	...
	{
		if (jetpackFuel < jetpackFuelMax && (Time.time - lastJumpButtonTime > 1))
		{
			jetpackFuel += .1;
		}
	}
